function! ctrlp_settings#utils#GetLinePrefixLen(ispath) abort
...
function! ctrlp_settings#utils#HighlightPositions(items, list_of_char_positions, line_prefix_len) abort
    let l:result = []
...
function! ctrlp_settings#utils#HighlightDefault(str) abort
